        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex gap-5">
            ...
            {pluginNavItems.map((item) =>
              ...
              !hasPermission(item.required_permission) ? null : (
                <Link
                  key={item.path}
                  to={item.path}
        ...
        <div className="flex items-center gap-3">
          ...
          {isAuthenticated && user ? (
            <>
              ...
              <button
                onClick={logout}
                className="px-3 py-1 text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-200 border border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800"
              >
                退出
              </button>
            </>
