...
const components: Components = {
  ...
  h2: ({ children }) => (
    <h2 className="text-xl font-bold text-gray-800 dark:text-gray-100 mt-5 mb-3">
      {children}
    </h2>
  ),
  h3: ({ children }) => (
  ...
  h4: ({ children }) => (
    <h4 className="text-base font-semibold text-gray-700 dark:text-gray-200 mt-3 mb-1">
      {children}
    </h4>
  ),
  h5: ({ children }) => (
    <h5 className="text-sm font-semibold text-gray-600 dark:text-gray-300 mt-2 mb-1">
      {children}
    </h5>
  ),
  h6: ({ children }) => (
    <h6 className="text-xs font-semibold text-gray-500 dark:text-gray-400 mt-2 mb-1">
      {children}
    </h6>
  ),
  p: ({ children }) => (
  ...
  ul: ({ children }) => (
    <ul className="list-disc pl-5 mb-3 space-y-1 text-sm text-gray-700 dark:text-gray-300">
      {children}
    </ul>
  ),
  ol: ({ children }) => (
    <ol className="list-decimal pl-5 mb-3 space-y-1 text-sm text-gray-700 dark:text-gray-300">
      {children}
    </ol>
  ),
  li: ({ children }) => (
  ...
  code: ({ className, children, ...props }) => {
    ...
    if (!className) {
      return (
        <code className="bg-gray-100 dark:bg-gray-800 text-red-600 dark:text-red-400 px-1 py-0.5 text-xs rounded">
          {children}
        </code>
      );
    }
    ...
    return (
      <pre
        className={`text-sm rounded mb-3 ${isWrap ? "bg-gray-900 text-gray-100 p-4 whitespace-pre-wrap break-words" : "bg-gray-900 text-gray-100 p-4 overflow-x-auto"}`}
      >
  ...
  blockquote: ({ children }) => (
    <blockquote className="border-l-4 border-gray-300 dark:border-gray-700 pl-4 italic text-gray-600 dark:text-gray-400 mb-3">
      {children}
    </blockquote>
  ),
  table: ({ children }) => (
  ...
  th: ({ children }) => (
    <th className="border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-800 px-3 py-2 text-left font-semibold text-gray-700 dark:text-gray-200">
      {children}
    </th>
  ),
  td: ({ children }) => (
