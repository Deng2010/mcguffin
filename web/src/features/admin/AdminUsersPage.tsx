          ...
          <tbody>
            {users.map((u) => (
              ...
              >
                ...
                <td className="py-3 px-3 text-gray-800 dark:text-gray-100">
                  {u.display_name}
                </td>
                <td className="py-3 px-3">
                  {u.id === "admin" ? (
                    <span className="text-xs px-2 py-0.5 bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400 border border-yellow-300 dark:border-yellow-800">
                      superadmin
                    </span>
                  ) : (
                    <select
                  ...
                  <div className="flex flex-wrap gap-1">
                    {u.group_ids.map((gid) => {
                      ...
                      return g ? (
                        <span
                          key={gid}
                          className="text-xs px-1.5 py-0.5 bg-indigo-100 text-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-300"
                        >
                          {g.name}
                        </span>
                      ) : null;
