              ...
              >
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-4 py-2 bg-gray-800 dark:bg-gray-700 text-white border border-gray-900 hover:bg-gray-700 dark:hover:bg-gray-600"
                  >
                    接受
                  </button>
                  <button
                    onClick={() => handleReviewRequest(req.id, "reject")}
                    className="px-4 py-2 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700"
                  >
                    拒绝
                  </button>
                </div>
          ...
          filteredMembers.map((m) => (
            ...
            >
              ...
              >
                ...
                <div
                  className={`w-10 h-10 bg-gray-300 dark:bg-gray-700 rounded-full flex items-center justify-center text-gray-600 dark:text-gray-400 font-bold text-sm ${m.avatar_url ? "hidden" : ""}`}
                >
                  {m.name.charAt(0)}
                </div>
                <div>
