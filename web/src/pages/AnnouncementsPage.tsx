      ...
      {announcements.length === 0 ? (
        ...
        <div className="space-y-3">
          {announcements.map((a) => (
            <div
              key={a.id}
              className={`bg-white border dark:bg-gray-900 shadow ${a.pinned ? "border-yellow-400 ring-1 ring-yellow-100 dark:border-yellow-800 dark:ring-yellow-900/30" : "border-gray-300 dark:border-gray-700"}`}
            >
              <div className="p-4">
