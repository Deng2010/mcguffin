      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 shadow p-6">
        ...
        <div className="mt-6">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed space-y-2">
            <p>你试图访问的页面不在本题空间中。</p>
            <p>
              给定一个错误的请求 URL，请判断是否存在从当前 URL
              到有效页面的路径。
            </p>
            <p>由于这是一道不可解题，你只需要输出一行 "404" 即可获得满分。</p>
          </div>
        </div>
        ...
        <div className="mt-6">
          ...
          <div className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
            <p>
              一行，包含字符串{" "}
              <code className="px-1.5 py-0.5 bg-gray-100 dark:bg-gray-800 text-gray-800 dark:text-gray-200 font-mono">
                404
              </code>
              。
            </p>
        ...
        <div className="mt-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <pre className="px-4 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-sm font-mono text-gray-700 dark:text-gray-300 overflow-x-auto">
                （空）
              </pre>
            </div>
            <div>
