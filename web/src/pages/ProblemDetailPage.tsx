...
export default function ProblemDetailPage() {
  ...
  const canEdit = problem && user && (isAdmin || problem.author_id === user.id);
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <Link
        to="/problems"
        className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-800 dark:hover:text-gray-100 mb-4 inline-block"
      >
        ← 返回列表
      </Link>
      ...
      <div className="bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 p-6 mb-6 shadow">
        ...
        {editMsg && (
          <div
            className={`mb-4 p-3 text-sm border ${editMsg === "已保存" ? "bg-green-50 dark:bg-green-900/30 border-green-300 dark:border-green-800 text-green-700 dark:text-green-300" : "bg-red-50 dark:bg-red-900/30 border-red-300 dark:border-red-800 text-red-700 dark:text-red-300"}`}
          >
            {editMsg}
          </div>
        )}
          ...
          <>
            ...
            {problem.solution !== undefined && problem.solution !== "" && (
              <div className="mt-6">
                ...
                <MarkdownRenderer
                  content={problem.solution || "(空)"}
                  className="bg-blue-50 dark:bg-blue-900/30 p-4 border border-blue-200 dark:border-blue-800"
                />
              </div>
            )}
          </>
